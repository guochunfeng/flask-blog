...
from prompt_toolkit.win32_types import LP_CONSOLE_SCREEN_BUFFER_INFO, STD_OUTPUT_HANDLE, STD_INPUT_HANDLE, COORD, SMALL_RECT
...
class Win32Output(Output):
    ...
    def get_win32_screen_buffer_info(self):
        ...
        self.flush()
        sbinfo = LP_CONSOLE_SCREEN_BUFFER_INFO()
        #sbinfo = CONSOLE_SCREEN_BUFFER_INFO()
        success = windll.kernel32.GetLpConsoleScreenBufferInfo(self.hconsole, byref(sbinfo))
