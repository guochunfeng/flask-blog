...
from app.models import User,Role,Post,Permission,AnonymousUser,Alembic
...
def make_shell_context():
	return dict(app=app,db=db,User=User,Role=Role,Post=Post,Permission=Permission,AnonymousUser=AnonymousUser,Alembic=Alembic)
